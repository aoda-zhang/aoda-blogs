## Motivation
In the first five years of my career as a software engineer , 
...
<iframe height="500" src="https://react-practice.aoda.vercel.app"></iframe>
What we'll building is a project whitch can record our short trip,i call it TripSnap, we will includes those below features. <br/>

- Register & Login.
- Submit short trip information.
...
### BackEnd
- <b>Environment Config management :</b> How to manage the project configs of different environment by yaml files.
- <b>openAPI :</b> How to know each API information for frontEnd developer ? 
- <b>Microservices :</b> How to separate big project to microservice ?
- <b>Message queue and cache application :</b> How to use message queue and cache to optimize big project ?
### Devops
