...
Before you start learning fullStack jonry, you should know or do the following things.<br/>
- Understand basic javascript syntax.
- Understand basic react (>= 16.8 version) and Nestjs syntax.
- Download your favorite IDE (VScode is recommended)
